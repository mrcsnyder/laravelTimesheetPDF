...
<div class="container">
    ...
    <div class="row">
        <div class="col-large-6">
            <h2>
                <img class="timesheet-logo" src="{{public_path()}}/images/logo.png" alt="Your Company">
                &nbsp;Your Company</h2>
    ...
    {{pdfHourlyCalendar($timesheetData['hidemonth'], $timesheetData['hideyear'], $timesheetData)}}
