...
<div class="container">
    ...
    <div class="row">
        <div class="col-large-6">
            <h1>
                <img class="timesheet-logo" src="{{public_path()}}/images/logo.png" alt="Your Company Name">
...
<table class="table table-bordered">
    ...
    <tr class="text-center">
        <td>{{$timesheetData['first']}}</td>
        <td>{{$timesheetData['second']}}</td>
        <td>{{$timesheetData['third']}}</td>
        <td>{{$timesheetData['fourth']}}</td>
        <td>{{$timesheetData['fifth']}}</td>
        <td>{{$timesheetData['sixth']}}</td>
        <td>{{$timesheetData['seventh']}}</td>
        <td>{{$timesheetData['eighth']}}</td>
        <td>{{$timesheetData['ninth']}}</td>
        <td>{{$timesheetData['tenth']}}</td>
    </tr>
...
<thead>
    ...
    <tr class="text-center">
        <td>{{$timesheetData['eleventh']}}</td>
        <td>{{$timesheetData['twelfth']}}</td>
        <td>{{$timesheetData['thirteenth']}}</td>
        <td>{{$timesheetData['fourteenth']}}</td>
        <td>{{$timesheetData['fifteenth']}}</td>
        <td>{{$timesheetData['sixteenth']}}</td>
        <td>{{$timesheetData['seventeenth']}}</td>
        <td>{{$timesheetData['eighteenth']}}</td>
        <td>{{$timesheetData['nineteenth']}}</td>
        <td>{{$timesheetData['twentieth']}}</td>
    </tr>
    ...
    <tr class="text-center">
        <td>{{$timesheetData['twenty_first']}}</td>
        <td>{{$timesheetData['twenty_second']}}</td>
        <td>{{$timesheetData['twenty_third']}}</td>
        <td>{{$timesheetData['twenty_fourth']}}</td>
        <td>{{$timesheetData['twenty_fifth']}}</td>
        <td>{{$timesheetData['twenty_sixth']}}</td>
        <td>{{$timesheetData['twenty_seventh']}}</td>
        <td>{{$timesheetData['twenty_eighth']}}</td>
        <td>{{$timesheetData['twenty_ninth']}}</td>
        <td>{{$timesheetData['thirtieth']}}</td>
        <td>{{$timesheetData['thirty_first']}}</td>
    </tr>
